 ...
 <body class="text-left">
         ...
         <div class="main-content-wrap sidenav-open d-flex flex-column">
             ...
             <div class="main-content">
                 <div class="breadcrumb">
                     <h1 class="font-weight-bold">Formulário de Registo de Distrito</h1>
                 </div>
                                     ...
                                     <div class="row">
                                         <div class="col-md-12">
                                             ...
                                             <div class="row">
                                                 ...
                                                 <div class="col-md-4 mb-3">
                                                     <label for="" style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;">Provincia<span class="text-danger" style="font-family: 'Arial narrow'; font-size: 14px; color: #6b6076; line-height: 21px; font-weight: bold">*</span></label>
     ...
     <script>
         ...
         $(document).ready(function() {
             ...
             //  $(document).on("click", "#registar_aluno", function(e) {
             //      createAluno()
             //  });
