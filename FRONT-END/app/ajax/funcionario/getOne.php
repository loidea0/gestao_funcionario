...
<form action="#" method="post" id="form_funcionario">
                                     <div class="row">
                                         <div class="col-md-12">
                                             ...
                                             <div class="row">
                                                 <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" value="<?=$funcionario->data[0]->nome?>" name="nome_func" id="nome_func" class="form-control" required>
                                                    </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <input type="date" name="data_nascimento" id="data_nascimento" class="form-control start_date" value="<?=$extras->date_format3($funcionario->data[0]->data_nascimento)?>" required>
                                                 </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="genero_func" id="genero_func" class="form-control select2" required>
                                                         ...
                                                         <option <?=$funcionario->data[0]->genero == "M" ? "selected" : ""?> value="M">Masculino</option>
                                                         <option <?=$funcionario->data[0]->genero == "F" ? "selected" : ""?> value="F">Feminino</option>
                                                     </select>
                                                 </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="id_departamento" id="id_departamento" class="form-control select2" required>
                                                         ...
                                                         <?php foreach ($departamento->data as $item) : ?>
                                                             <option <?=$funcionario->data[0]->departamento == $item->nome ? "selected" : ""?> value="<?= $item->id ?>"><?= $item->nome ?></option>
                                                         <?php endforeach ?>
                                                     </select>
                                                 </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <input type="text" value="<?=$funcionario->data[0]->contacto?>" name="contacto" id="contacto" class="form-control" required>
                                                 </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="id_provincia_modal" id="id_provincia_modal" class="form-control select2" required>
                                                         ...
                                                         <?php foreach ($provincia->data as $item) : ?>
                                                            <?php if($funcionario->data[0]->provincia == $item->nome) :
                                                 ...
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="id_distrito_modal" id="id_distrito_modal" class="form-control select2" required>
                                                         ...
                                                         <?php foreach ($distritos->data as $item) : ?>
                                                             <option <?= $item->nome == $funcionario->data[0]->distrito ? "selected" : "" ?> value="<?= $item->id ?>"><?= $item->nome ?></option>
                                                         <?php endforeach ?>
                                                     </select>
                                                 </div>
