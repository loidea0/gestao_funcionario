...
//echo "CONTACTO: ".$response->data[0]->nome;
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1 class="font-weight-bold">Detalhes do Funcionario</h1>
                </div>
                                                ...
                                                <div class="col-md-10 col-sm-9">
                                                    <div class="row">
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                            ...
                                                            <input  style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 500;" value="<?=$response->data[0]->id ?>" class="form-control" disabled> 
                                                        ...
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                            ...
                                                            <input style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 500;" value="<?=$response->data[0]->nome; ?>" class="form-control" disabled>
                                                        </div>
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                        ...
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                            <label for="">Data de Nascimento <span class="text-danger" style="font-family: 'Arial narrow'; font-size: 14px; color: #6b6076; line-height: 21px; font-weight: bold; "></span></label>
                                                             <input value="<?=$extras->date_format2($response->data[0]->data_nascimento); ?>" class="form-control" disabled>
                                                        </div>
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                            ...
                                                            <select name="provincia" id="provincia" class="form-control select" disabled>
                                                        ...
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                            ...
                                                            <select name="distrito" id="distrito" class="form-control select" disabled>
                                                                <option> <?= $response->data[0]->distrito; ?></option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-4 col-sm-6 mb-3">
                                                            <label for="">Departamento<span class="text-danger" style="font-family: 'Tahoma Verda'; font-size: 14px; color: #6b6076; line-height: 21px; font-weight: 600"></span></label>
                                                            <select name="departamento" id="departamento" class="form-control select" disabled>
