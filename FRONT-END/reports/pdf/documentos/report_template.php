...
<small><div><label style="text-align=left; font-weight: bold;" class="h6">&copy; Copyright <strong style="font-weight: bold;">Academia, Consultoria & Serviços Universo - ACSUN <img src="../img/logo.png" alt="" style="width: 10px; height: 10px; text-align: left; margin-top: 200px; "> </strong></label></div> <div style="text-align: right">{PAGENO} of {nbpg}</div></small>');
// $html2pdf->SetHTMLFooter('<small><div><label style="text-align=left; font-weight: bold;" class="h6">&copy; Copyright <strong style="font-weight: bold;">Academia, Consultoria & Serviços Universo - ACSUN <img src="../img/logo.png" alt="" style="width: 10px; height: 10px; text-align: left; margin-top: 100px; "> </strong></label></div> <div style="text-align: right">{PAGENO} of {nbpg}</div></small>', 'E');
