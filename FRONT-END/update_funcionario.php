         ...
         <div class="main-content-wrap sidenav-open d-flex flex-column">
             ...
             <div class="main-content">
                 <div class="breadcrumb">
                     <h1 class="font-weight-bold">Editar Funcionario</h1>
                 </div>
                     ...
                     <div class="col-md-12">
                         <div class="card mb-3">
                             <div class="card-body">
                                 ...
                                 <form action="#" method="post" id="form_funcionario_update">
                                         ...
                                         <div class="col-md-12">
                                             ...
                                             <div class="row">
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <input type="text" name="nome" id="nome" value="<?=$response->data[0]->nome; ?>" class="form-control" required>
                                                 </div>
                                                 <div class="col-md-4 col-sm-6 mb-3">
                                                 <label for="" style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;"> Data nascimento<span class="text-danger" style="font-family: 'Arial narrow'; font-size: 14px; color: #6b6076; line-height: 21px; font-weight: bold">*</span></label>
                                                             <input type="date" name="data_nascimento" value="<?=$extras->date_format3($response->data[0]->data_nascimento); ?>" class="form-control" id="data_nascimento"  required>
                                                        </div>
                                                 ...
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="id_departamento" id="id_departamento" class="form-control select2" required>
                                                         ...
                                                         <?php foreach ($departamento->data as $item) : ?>
                                                             <option  value="<?= $item->id ?>"  <?=$item->nome == $response->data[0]->departamento ? "selected" : "" ?>  >  <?= $item->nome ?>  </option>
                                                        <?php endforeach ?>
                                                     </select>
                                                 </div>
                                                 ...
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <input type="text" name="contacto" id="contacto" class="form-control" value="<?=$response->data[0]->contacto; ?>" required>
                                                 </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="id_provincia" id="provincia_id" class="form-control select2" required>
                                                         <option value="">--selecione uma opção--</option>
                                                         <?php foreach ($provincia->data as $item) : ?>
                                                            <option  value="<?= $item->id ?>"  <?=$item->nome == $response->data[0]->provincia ? "selected" : "" ?>  >  <?= $item->nome ?>  </option>
                                                         <?php endforeach ?>
                                                     </select>
                                                 </div>
                                                 <div class="col-md-4 mb-3">
                                                     ...
                                                     <select name="id_distrito" id="id_distrito" class="form-control select2" required>
                                                         <option value="">--selecione uma opção--</option>
                                                         <?php foreach ($distrito->data as $item) :                                              
                                                                if($item->nome == $response->data[0]->distrito){ ?>
