...
from controllers import blpFuncionario, blpProvincia, blpDistrito, blpDepartamento, blpPresenca, blpDashboard, blpAvaliacaoDesempenho
def create_app(test_config=None):
    ...
    api.register_blueprint(blpPresenca)
    api.register_blueprint(blpDashboard)
    api.register_blueprint(blpAvaliacaoDesempenho)
